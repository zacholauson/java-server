...
public class HTTPRequest implements IRequest {
    ...
    public String headerString()             { return headerString; }
    ...
    private HashMap<String, String> getHeadersHash() {
    ...
    private String getRoute() throws UnsupportedEncodingException {
